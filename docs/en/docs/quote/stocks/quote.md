...
| ∟∟ low              | string   | Low                                                                                                                                                                                                         |
| ∟∟ prev_close       | string   | Close of the last trade session                                                                                                                                                                             |
| ∟ over_night_quote  | object   | Quote of US overnight market<br/><br/>Note: Enable the `enable_overnight` parameter to receive it; returns null otherwise. (Overnight quotes are included free in US LV1, US stocks only.) |
| ∟∟ last_done        | string   | Latest price                                                                                                                                                                                                |
| ∟∟ timestamp        | int64    | Time of latest price                                                                                                                                                                                        |
| ∟∟ volume           | int64    | Volume                                                                                                                                                                                                      |
| ∟∟ turnover         | string   | Turnover                                                                                                                                                                                                    |
