...
推薦優先從 ChatGPT 開始使用，因為 Longbridge 已經可以直接在 ChatGPT Apps 中搜尋並授權。其他 MCP 客戶端的配置格式可能隨版本變更，請以客戶端官方文件為準。
...
![在 ChatGPT Apps 中搜尋 Longbridge](https://assets.lbkrs.com/uploads/aeb84040-b2c7-442d-af46-adfab66297a1/scr-20260707-nbjr.png)

![授權 Longbridge ChatGPT App](https://assets.lbkrs.com/uploads/a66bcd75-d747-4259-b684-a689d324716c/scr-20260707-nbno.png)

完成授權後，在 ChatGPT 輸入框中輸入 `@longbridge`，即可開啟 Longbridge MCP 查詢行情、帳戶或持倉數據。
...
在 ChatGPT 中，授權會在從 Apps 新增 Longbridge 時完成；在其他 MCP 客戶端中，通常由首次工具調用觸發瀏覽器授權流程。
