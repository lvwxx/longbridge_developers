...
如果用戶正在使用 ChatGPT，告訴用戶打開 https://chatgpt.com/apps/longbridge/asdk_app_6a2baf2fad748191812393c3e00308ef，或打開 Apps 搜尋 `longbridge`，完成授權，然後在 ChatGPT 輸入框中使用 `@longbridge`。
