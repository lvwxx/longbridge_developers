...
推荐优先从 ChatGPT 开始使用，因为 Longbridge 已经可以直接在 ChatGPT Apps 中搜索并授权。其他 MCP 客户端的配置格式可能随版本变更，请以客户端官方文档为准。
...
![在 ChatGPT Apps 中搜索 Longbridge](https://assets.lbkrs.com/uploads/aeb84040-b2c7-442d-af46-adfab66297a1/scr-20260707-nbjr.png)
...
在 ChatGPT 中，授权会在从 Apps 添加 Longbridge 时完成；在其他 MCP 客户端中，通常由首次工具调用触发浏览器授权流程。
